...
import { AuthCodePlatformer } from "@/lib/game/AuthCodePlatformer";
import Link from "next/link";
import { ArrowLeft } from "lucide-react";

export default function AuthCodePlatformerPage() {
    const scene = useMemo(() => new AuthCodePlatformer(), []);
            ...
            <div className="absolute top-0 left-0 w-full p-6 z-10 flex justify-between items-start pointer-events-none">
                ...
                <div className="bg-neutral-900/50 p-4 rounded-xl backdrop-blur-sm border border-neutral-800 text-right max-w-sm pointer-events-auto">
                    ...
                    <p className="text-sm text-neutral-400">
                        Goal: <span className="text-purple-400">Login (Get Code)</span> &rarr; <span className="text-blue-400">Return to App</span> &rarr; <span className="text-green-400">Access API</span>.
                    </p>
                </div>
            </div>
